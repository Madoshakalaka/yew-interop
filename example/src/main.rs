...
pub fn cropper_example() -> Html {
    ...
    html! {
        <>
            ...
            <div>
                <img ref={image_ref} src={static_url!("yew-logo.png")} class={css!("width: 10rem; height: 10rem; display: block; max-width: 100%;")}/>
            </div>
        </>
    }
}
...
pub fn app() -> Html {
    ...
    html! {
        ...
        <ResourceProvider>
            ...
            <a class={github_link} target="_blank" rel="noopener" href={format!("https://github.com/Madoshakalaka/yew-interop/tree/{}/example", option_env!("YEW_INTEROP_DEMO_VERSION").unwrap_or("master"))}>{"source code for this page "}
